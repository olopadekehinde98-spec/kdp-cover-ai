...
export default function AffiliateDashboard() {
  ...
  const NavBar = () => (
    <nav className="border-b border-gray-800 bg-gray-950/95 sticky top-0 z-40 px-6 py-4 flex items-center justify-between">
      <div className="flex items-center gap-4">
        <Link href="/" className="flex items-center gap-2">
          <div className="w-7 h-7 bg-violet-600 rounded-lg flex items-center justify-center font-black text-xs text-white">K</div>
          <span className="font-bold text-white text-sm">KDP Cover AI</span>
        </Link>
        <span className="text-gray-600">/</span>
        <span className="text-gray-400 text-sm">Affiliate Dashboard</span>
      </div>
